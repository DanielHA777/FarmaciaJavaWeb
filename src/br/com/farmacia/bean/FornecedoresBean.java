...
@ManagedBean(name = "MBFornecedores") // passa referencia da classe principal
@RequestScoped
public class FornecedoresBean {
	...
	public void excluir() {
		try {
			...
			JSFUtil.adicionarMensagemErro("Nao é possível excluir um fornecedor que tenha um produto associado!");
			e.printStackTrace();
		}
	}
